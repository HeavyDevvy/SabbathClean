                    ...
                    <CardContent className="p-6 flex flex-col h-full">
                      ...
                      <div className="mt-auto space-y-2">
                        <Button 
                          ...
                          className="w-full bg-gradient-to-r from-primary via-purple-600 to-primary hover:from-primary/90 hover:via-purple-600/90 hover:to-primary/90 text-white font-bold text-base py-3 px-4 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
